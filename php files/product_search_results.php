...
?>	  
 ...
 $mode_of_selling=$_REQUEST['mode_of_selling'];
 $food=$_REQUEST['food'];
 $company_name=$_REQUEST['company_name'];
 ?>

<body style="background-color:#FFA500;font-family: 'Montserrat', sans-serif;" data-spy="scroll" data-target=".navbar" data-offset="50">
...
<div class="container-fluid">
 ...
 <?php
               $sql = "SELECT * FROM ads_data WHERE (category LIKE '%".$category."%')  AND (mode_of_selling LIKE '%".$mode_of_selling."%') AND (food LIKE '%".$food."%') AND ( company_name LIKE '%".$company_name."%' ) AND (admin='yes') ORDER BY id DESC;;";
...
elseif ($row["category"]=='Automobiles') {
    $heading = "Automobiles & Industry";
} 
elseif ($row["category"]=='Food') {
    $heading = "Food & Retail";
}
elseif ($row["category"]=='Finance') {
...
?>
    ...
    <div class="card ">
	  ...
	  <hr>
	  <center>
	  <h5><b>  <?php echo  $heading; ?></b></h5>
	  <h5>  <?php echo  $row["product_name"]; ?></h5></center>
